...
/// <summary>
/// Interface for requirement handler class, responsible for checking resource against user claims
/// </summary>
...
public interface IRequirementHandler<T>
{
	...
	public Task<bool> CheckRequirement(T resource, List<Guid>? clientClaims, Guid? userClaim);
}
